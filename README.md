...
- 📖 **[คู่มือการใช้งานฉบับสมบูรณ์ (Offline User Manual)](docs/USER_MANUAL.md):** เอกสารแนะนำขั้นตอนการเตรียมกระดาษคำตอบ การพิมพ์ขนาด 100% การตรวจ และการส่งออกผลคะแนน
- 🌐 **[คู่มือออนไลน์บนเว็บไซต์ (Online Docs)](https://bithope.app/docs/exam-grader):** อ่านคู่มือเวอร์ชันเว็บที่อ่านง่ายบนมือถือและแท็บเล็ต
